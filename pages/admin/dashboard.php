...
<head>
    ...
    <title>Dashboard Admin | Nama Toko Anda</title>
    <link
    ...
    />
    <link rel="stylesheet" href="../../assets/css/style-admin-kopi.css" />
</head>
<body>
    <div class="d-flex" id="wrapper">
        <!-- Sidebar -->
        <div id="sidebar-wrapper">
            <div class="sidebar-heading">ADMIN TOKO</div>
            <div class="list-group list-group-flush">
                <a href="dashboard.php" class="list-group-item list-group-item-action active">
                    <i class="fas fa-tachometer-alt me-2"></i>Dashboard
                </a>
                <a href="product-management.php" class="list-group-item list-group-item-action">
        ...
        <div id="page-content-wrapper">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                >
                                    ...
                                    <?php echo htmlspecialchars($username); ?> (<?php echo $role; ?>)
                                </a>
                                <div
                                ...
                                >
                                    ...
                                    <a class="dropdown-item text-danger" href="dashboard.php?logout=true">
                                        Logout
                                    </a>
                                </div>
                            </li>
            ...
            <!-- Main Content -->
            <div class="container-fluid mt-5 py-4 main-content">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                ...
                                <p class="fs-5 mb-0">Pelanggan Baru</p>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">95%</h3>
                                <p class="fs-5 mb-0">Kepuasan Pelanggan</p>
                            </div>
                            <i class="fas fa-chart-line fs-1 text-danger"></i>
                        </div>
                    </div>
                </div>

                <h3 class="mt-4 mb-3">Pesanan Terbaru</h3>
                <div class="row my-5">
                    <div class="col">
                                ...
                                <table class="table bg-white rounded shadow-sm table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Ani M.</td>
                                            <td>Rp 715.000</td>
                                            <td><span class="badge bg-warning">Menunggu Bayar</span></td>
                                        </tr>
                                        <tr>
                                            <td>#ORD-002</td>
                                            <td>Budi S.</td>
            ...
            <footer class="admin-footer text-center">
                <div class="container-fluid">
                    <p class="mb-0 small">
                        © 2024 Nama Toko Anda | Dashboard Administrasi v1.0
                    </p>
                </div>
            </footer>
        </div>
    ...
    <script>
        ...
        // Otomatis sembunyikan sidebar di mobile
